...
private:
  ...
  void turnLampOnHandler(modular_server::Pin * pin_ptr);
  void turnLampOffHandler(modular_server::Pin * pin_ptr);
  void autozeroHandler(modular_server::Pin * pin_ptr);
  void isAutozeroingHandler();
  void playShortToneHandler(modular_server::Pin * pin_ptr);
  void playMediumToneHandler(modular_server::Pin * pin_ptr);
  void playLongToneHandler(modular_server::Pin * pin_ptr);
